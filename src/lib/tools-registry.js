...
const ALL_TOOLS = [
  ...
  // ===== 📄 基础工具（前端本地）=====
  { id: 'ai-text-detect', name: 'AI文本检测', desc: '检测文本是否AI生成', icon: '🔍', price: '9.9元/月', cat: 'basic', apiTool: true },
  ...
  { id: 'ai-translate', name: 'AI翻译对比', desc: '多模型翻译结果对比', icon: '🌐', price: '9.9元/月', cat: 'basic', apiTool: true },
  { id: 'ai-resume', name: 'AI简历优化', desc: 'AI改写优化你的简历', icon: '💼', price: '19.9元/月', cat: 'basic', apiTool: true },
  { id: 'prompt-templates', name: 'Prompt模板库', desc: '按场景分类的提示词模板', icon: '💡', price: '9.9元/月', cat: 'basic' },
  { id: 'ai-code-review', name: 'AI代码审查', desc: 'AI找出bug和优化建议', icon: '💻', price: '19.9元/月', cat: 'basic', apiTool: true },
  { id: 'seo-title-gen', name: 'SEO标题生成', desc: '批量生成SEO友好标题', icon: '📈', price: '9.9元/月', cat: 'basic', apiTool: true },
