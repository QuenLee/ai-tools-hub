...
const deals = [
  ...
  { name: 'Cursor', desc: 'AI编程IDE，Vibe Coding首选', current: '免费2000次/月', domain: 'cursor.com', tag: '免费版' },
  { name: '通义千问', desc: '阿里AI助手，API送100万tokens', current: 'API免费100万tokens', domain: 'tongyi.aliyun.com', tag: '开发者福利' },
  { name: 'Suno', desc: 'AI音乐生成，输入描述即可创作歌曲', current: '免费10首/天', domain: 'suno.com', tag: '免费版' },
  { name: '秘塔AI搜索', desc: '无广告AI搜索，直达结果', current: '免费版够用', domain: 'metaso.cn', tag: '免费版' },
  { name: 'ChatGPT', desc: '全球最流行的AI对话助手', current: '免费版可用', domain: 'chatgpt.com', tag: '免费版' },
  { name: 'Claude', desc: 'Anthropic出品，长文本处理最强', current: '免费版可用', domain: 'claude.ai', tag: '免费版' },
  { name: 'Hugging Face', desc: '开源模型社区，免费部署AI应用', current: '完全免费', domain: 'huggingface.co', tag: '永久免费' },
  { name: 'Google Colab', desc: '免费GPU云端Python笔记本', current: '免费GPU', domain: 'colab.research.google.com', tag: '开发者福利' },
];
...
export default async function DealsPage({ params }) {
  ...
  return (
    <div className="page" style={{ padding: '32px 0 80px' }}>
      ...
      <div style={{ marginTop: 28, padding: 20, background: 'var(--surface)', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border)' }}>
